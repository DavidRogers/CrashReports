...
namespace CrashReports
{
    ...
    partial void OnFixedInVersionChanging(string value);
    partial void OnFixedInVersionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FixedInVersion", DbType="NVarChar(20)")]
		public string FixedInVersion
		{
			...
			set
			{
				if ((this._FixedInVersion != value))
				{
					this.OnFixedInVersionChanging(value);
					this.SendPropertyChanging();
					this._FixedInVersion = value;
					this.SendPropertyChanged("FixedInVersion");
					this.OnFixedInVersionChanged();
				}
			}
		}
